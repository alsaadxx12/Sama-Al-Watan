      ...
      {isOpen && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center pointer-events-none md:p-4">
          ...
          >
            ...
            {/* Footer or Bottom Close Button */}
            {(footer || (hideHeader && showCloseButton)) && (
              <div className={`px-6 py-2 border-t shrink-0 ${theme === 'dark'
                ...
                {footer ? (
                  ...
                  <div className="flex justify-center">
                    <button
                      onClick={onClose}
                      className={`px-10 py-2.5 rounded-2xl font-black text-xs transition-all shadow-lg ${closeButtonVariant === 'danger'

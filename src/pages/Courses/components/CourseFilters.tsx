...
import { CreditCard, DollarSign, Filter, MessageCircle, X, BookOpen, Search, User, Briefcase, SlidersHorizontal } from 'lucide-react';
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-1.5 p-1 bg-gray-50 dark:bg-gray-900/50 rounded-2xl">
                  {[
                    ...
                    { id: 'company', label: 'دورات', icon: BookOpen, activeClass: 'bg-indigo-600 text-white shadow-indigo-500/20' },
                    { id: 'client', label: 'طلاب', icon: User, activeClass: 'bg-emerald-600 text-white shadow-emerald-500/20' },

...
export default function CoursesGrid({
  ...
  return (
    <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-lg">
            <button
              ...
              className={`p-1.5 rounded-md transition-colors ${gridView === 'grid'
            ...
            <button
              ...
              className={`p-1.5 rounded-md transition-colors ${gridView === 'compact'
                ? 'bg-white text-primary shadow-sm'
                : 'text-gray-500 hover:bg-white/50'
                }`}
              title="عرض مدمج"
            ...
            <button
              ...
              className={`p-1.5 rounded-md transition-colors ${gridView === 'list'
                ? 'bg-white text-primary shadow-sm'
                : 'text-gray-500 hover:bg-white/50'
                }`}
              title="عرض قائمة"
      ...
      <div className={`grid grid-cols-1 ${gridView === 'grid' ? 'md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8' :
        gridView === 'compact' ? 'md:grid-cols-3 lg:grid-cols-4 gap-4' :
          ...
          >
            {gridView === 'list' ? (
              ...
              <CourseCard
                ...
                onEdit={() => onEdit(course)}
                onDelete={() => onDelete(course)}
                onAddStudent={onAddStudent ? () => onAddStudent(course) : undefined}
                onViewDetails={onViewDetails ? () => onViewDetails(course) : undefined}
              ...
              {getPaginationItems.map((item, index) =>
                item === '...' ? (
                  ...
                  <button
                    ...
                    className={`w-8 h-8 flex items-center justify-center rounded-md ${currentPage === item

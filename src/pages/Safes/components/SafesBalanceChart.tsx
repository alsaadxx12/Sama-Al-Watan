  ...
  return (
    <div className={`p-6 rounded-2xl border ${theme === 'dark'
      ...
      <div className="flex items-center gap-3 mb-6">
        <div className={`p-2.5 rounded-xl ${theme === 'dark' ? 'bg-blue-900/30' : 'bg-blue-100'
          }`}>
          <TrendingUp className={`w-5 h-5 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'
            }`} />
        </div>
        <h3 className={`text-lg font-bold ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'
          }`}>
          ملخص الأرصدة
        </h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* USD Balance */}
        <div className={`p-6 rounded-xl border-2 relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${theme === 'dark'
          ...
          <div className="flex items-center gap-4 mb-3">
            <div className={`p-3 rounded-xl flex-shrink-0 ${theme === 'dark' ? 'bg-emerald-500/20' : 'bg-emerald-100'
              }`}>
          ...
          <p className={`text-4xl font-black text-right pr-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'
            }`}>
        ...
        {/* Total Value in USD */}
        <div className={`p-6 rounded-xl border-2 relative overflow-hidden flex flex-col items-center justify-center text-center transition-all duration-300 hover:shadow-2xl hover:scale-105 ${theme === 'dark'
        ...
        <div className={`p-6 rounded-xl border-2 relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${theme === 'dark'
          ...
          <div className="flex items-center gap-4 mb-3">
            <div className={`p-3 rounded-xl flex-shrink-0 ${theme === 'dark' ? 'bg-purple-500/20' : 'bg-purple-100'
              }`}>
          ...
          <p className={`text-4xl font-black text-right pr-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'
            ...
            {formatCurrency(totalIQD)} <span className="text-2xl">IQD</span>
          </p>
        </div>
      </div>
    </div>
